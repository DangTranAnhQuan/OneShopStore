document.addEventListener('DOMContentLoaded', function () {
    ...
    if (carriersTable) {
        ...
        editModal.addEventListener('show.bs.modal', function (event) {
            ...
            modalForm.querySelector('[name="carrierId"]').value = id;
            modalForm.querySelector('[name="carrierName"]').value = name;
    ...
    const tiersTable = document.getElementById('tiersTable');
        if (tiersTable) {
            ...
            editModal.addEventListener('show.bs.modal', function (event) {
                ...
                const modalForm = editModal.querySelector('form');
                modalForm.querySelector('[name="tierId"]').value = id;
                modalForm.querySelector('[name="tierName"]').value = name;
                modalForm.querySelector('[name="minPoints"]').value = points;
                modalForm.querySelector('[name="discountPercentage"]').value = discount;
            });
        }
